...
Purpose: To test functions from the controller library and test the output of those functions,

Expected Outcome: Test button, trigger, and joystick commands to verify their output.
"""
...
def update():
    if rc.controller.is_down(rc.controller.Button.A):
        ...
        print(f"Left_Trigger = {l_trigger} || Right Trigger = {r_trigger}")
